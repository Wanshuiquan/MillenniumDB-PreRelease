        ...
        switch (model_identifier) {
            case QuadCatalog::MODEL_ID: {
                ...
                try {
                    ...
                    DurationMS parser_duration = std::chrono::system_clock::now() - start_parser;
                    ...
                    DurationMS optimizer_duration = std::chrono::system_clock::now() - start_optimizer;
                    ...
                    DurationMS execution_duration = std::chrono::system_clock::now() - execution_start;
