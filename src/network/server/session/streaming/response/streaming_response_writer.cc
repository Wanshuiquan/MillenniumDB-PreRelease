...
void StreamingResponseWriter::write_run_success(const std::vector<VarId>& projection_vars) {
...
void StreamingResponseWriter::write_pull_success_has_next() {
    write_map_header(2UL);
    write_string("type", Protocol::DataType::STRING);
    write_uint8(static_cast<uint8_t>(Protocol::ResponseType::SUCCESS));
...
void StreamingResponseWriter::write_discard_success() {
    write_map_header(2UL);
    write_string("type", Protocol::DataType::STRING);
    write_uint8(static_cast<uint8_t>(Protocol::ResponseType::SUCCESS));
...
void StreamingResponseWriter::write_pull_success_final(uint64_t result_count,
...
std::string StreamingResponseWriter::encode_string(const std::string& value, Protocol::DataType data_type) const {
    std::string res;
...
void StreamingResponseWriter::write_path_edge(std::ostream& os, ObjectId oid, bool reverse, uint_fast32_t* path_length) const {
